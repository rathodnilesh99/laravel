    ...
    <div class="container py-10 md:py-50px lg:py-60px 2xl:py-100px">
        ...
        <div class="lg:col-start-1 lg:col-span-8 space-y-[35px]">
            ...
            <div class="overflow-hidden relative mb-5">
                <img
                    src="{{ asset('./assets/images/blog/blog_8.png') }}" alt=""
                    class="w-full"
                >
            </div>
            <!-- course content -->
                ...
                <div class="tab-contents">
                    ...
                    <div class="mt-60px mb-10">
                        ...
                        >
                            ...
                            <div>
                                <img
                                src="{{ asset('./assets/images/teacher/teacher__2.png') }}" alt=""
                        ...
                        >
                            ...
                            <div>
                                <img
                                src="{{ asset('./assets/images/teacher/teacher__1.png') }}" alt=""
                                class="w-25 h-25 rounded-full"
                                >
                            </div>
                            </div>
                        ...
                        >
                            ...
                            <div>
                                <img
                                src="{{ asset('./assets/images/teacher/teacher__3.png') }}" alt=""
                                class="w-25 h-25 rounded-full"
                                >
                            </div>
                            </div>
                    ...
                    >
                        ...
                        <img
                            src="{{ asset('./assets/images/blog/blog_10.png') }}" alt=""
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="w-full group grid-item filter1 filter3">
                            ...
                            >
                                ...
                                <a href="{{ url('course') }}" class="w-full">
                                    <img
                                    src="{{ asset('./assets/images/grid/grid_1.png') }}" alt=""
                        ...
                        <div class="w-full group grid-item filter1 filter3">
                            ...
                            >
                                ...
                                <a href="{{ url('course') }}" class="w-full">
                                    <img
                                    src="{{ asset('./assets/images/grid/grid_2.png') }}" alt=""
                                    class="w-full transition-all duration-300 group-hover:scale-110"
                                    >
                                </a>
                                <div
                        ...
                        <div class="w-full group grid-item filter1 filter3">
                            ...
                            >
                                ...
                                <a href="{{ url('course') }}" class="w-full">
                                    <img
                                    src="{{ asset('./assets/images/grid/grid_3.png') }}" alt=""
                                    class="w-full transition-all duration-300 group-hover:scale-110"
                                    >
                                </a>
                                <div
                        ...
                        <div class="w-full group grid-item filter1 filter3">
                            ...
                            >
                                ...
                                <a href="{{ url('course') }}" class="w-full">
                                    <img
                                    src="{{ asset('./assets/images/grid/grid_4.png') }}" alt=""
                                    class="w-full transition-all duration-300 group-hover:scale-110"
                                    >
                                </a>
                                <div
                        ...
                        <div class="w-full group grid-item filter1 filter3">
                            ...
                            >
                                ...
                                <a href="{{ url('course') }}" class="w-full">
                                    <img
                                    src="{{ asset('./assets/images/grid/kid_5.jpg') }}" alt=""
                                    class="w-full transition-all duration-300 group-hover:scale-110"
                                    >
                                </a>
                                <div
                        ...
                        <div class="w-full group grid-item filter1 filter3">
                            ...
                            >
                                ...
                                <a href="{{ url('course') }}" class="w-full">
                                    <img
                                    src="{{ asset('./assets/images/grid/kid_6.jpg') }}" alt=""
                                    class="w-full transition-all duration-300 group-hover:scale-110"
                                    >
                                </a>
                                <div
