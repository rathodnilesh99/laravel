            ...
            <div class="container">
                <div class="text-center">
                    ...
                    <ul class="flex gap-1 justify-center">
                        ...
                        <li>
                            <span class="text-lg text-blackColor2 dark:text-blackColor2-dark">Course-Details</span>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="lg:col-start-1 lg:col-span-8 space-y-[35px]">
                    ...
                    <div data-aos="fade-up">
                        ...
                        <div class="overflow-hidden relative mb-5">
                            <img src="{{ asset('./assets/images/blog/blog_8.png') }}" alt="" class="w-full">
                        </div>
                        <!-- course content -->
                        <div>
                                        ...
                                        <div class="mt-60px mb-10">
                                            ...
                                            <ul>
                                                ...
                                                <li
                                                    ...
                                                    <div class="flex-shrink-0">
                                                        <div>
                                                            <img src="{{ asset('./assets/images/teacher/teacher__3.png') }}"
                                                                alt="" class="w-25 h-25 rounded-full">
                                                        </div>
                                                    </div>
                                                    <div class="flex-grow">
                            ...
                            <div class="mt-50px mb-30px" data-aos="fade-up">
                                ...
                                <div class="flex items-center justify-between mb-10px">
                                    ...
                                    <a href="{{ url('course') }}"
                                        class="text-contentColor dark:text-contentColor-dark">More Courses...</a>
                                </div>
                                                    ...
                                                    <div class="tab-content-wrapper sm:px-15px mb-30px">
                                                        <div
                                                            ...
                                                            <div class="relative mb-4 overflow-hidden">
                                                                <a href="{{ url('course') }}" class="w-full">
                                                                    <img src="{{ asset('./assets/images/grid/grid_1.png') }}"
                                                                        alt=""
                                                ...
                                                <div class="w-full group grid-item filter1 filter3">
                                                    <div class="tab-content-wrapper sm:px-15px mb-30px">
                                                        <div
                                                            ...
                                                            <div class="relative mb-4 overflow-hidden">
                                                                <a href="{{ url('course') }}" class="w-full">
                                                                    <img src="{{ asset('./assets/images/grid/grid_2.png') }}"
                                                                        alt=""
                                                                        class="w-full transition-all duration-300 group-hover:scale-110">
                                                                </a>
                                                                <div
                                                ...
                                                <div class="w-full group grid-item filter1 filter3">
                                                    <div class="tab-content-wrapper sm:px-15px mb-30px">
                                                        <div
                                                            ...
                                                            <div class="relative mb-4 overflow-hidden">
                                                                <a href="{{ url('course') }}" class="w-full">
                                                                    <img src="{{ asset('./assets/images/grid/grid_3.png') }}"
                                                                        alt=""
                                                                        class="w-full transition-all duration-300 group-hover:scale-110">
                                                                </a>
                                                                <div
                                                ...
                                                <div class="w-full group grid-item filter1 filter3">
                                                    <div class="tab-content-wrapper sm:px-15px mb-30px">
                                                        <div
                                                            ...
                                                            <div class="relative mb-4 overflow-hidden">
                                                                <a href="{{ url('course') }}" class="w-full">
                                                                    <img src="{{ asset('./assets/images/grid/grid_4.png') }}"
                                                                        alt=""
                                                                        class="w-full transition-all duration-300 group-hover:scale-110">
                                                                </a>
                                                                <div
                                                ...
                                                <div class="w-full group grid-item filter1 filter3">
                                                    <div class="tab-content-wrapper sm:px-15px mb-30px">
                                                        <div
                                                            ...
                                                            <div class="relative mb-4 overflow-hidden">
                                                                <a href="{{ url('course') }}" class="w-full">
                                                                    <img src="{{ asset('./assets/images/grid/kid_5.jpg') }}"
                                                                        alt=""
                                                                        class="w-full transition-all duration-300 group-hover:scale-110">
                                                                </a>
                                                                <div
                                                ...
                                                <div class="w-full group grid-item filter1 filter3">
                                                    <div class="tab-content-wrapper sm:px-15px mb-30px">
                                                        <div
                                                            ...
                                                            <div class="relative mb-4 overflow-hidden">
                                                                <a href="{{ url('course') }}" class="w-full">
                                                                    <img src="{{ asset('./assets/images/grid/kid_6.jpg') }}"
                                                                        alt=""
                                                                        class="w-full transition-all duration-300 group-hover:scale-110">
                                                                </a>
                                                                <div
                ...
                <div class="lg:col-start-9 lg:col-span-4">
                    <div class="flex flex-col">
                        ...
                        <div class="py-33px px-25px shadow-event mb-30px bg-whiteColor dark:bg-whiteColor-dark rounded-md"
                            ...
                            <!-- meeting thumbnail -->
                            <div class="overflow-hidden relative mb-5">
                                <img src="{{ asset('./assets/images/blog/blog_7.png') }}" class="w-full">
                            ...
                            <ul class="flex flex-col gap-y-25px">
                                <li class="flex items-center">
                                    ...
                                    <div class="flex-grow">
                                        ...
                                        <a href="#"
                                            class="text-blackColor dark:text-blackColor-dark hover:text-primaryColor dark:hover:text-primaryColor font-semibold leading-22px">Making
                                            Music with Other People</a>
                                    </div>
                                </li>
                                <li class="flex items-center">
                                    <div class="w-[91px] h-auto mr-5 flex-shrink-0">
