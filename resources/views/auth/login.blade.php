          ...
          >
            <div class="tab-contents">
              ...
              <x-auth-session-status class="mb-4" :status="session('status')" />
                ...
                <form method="POST" class="pt-25px" data-aos="fade-up" action="{{ route('login') }}">
                  @csrf
                  <div class="mb-25px">
                    <label
                  ...
                  >
                    ...
                    @if (Route::has('password.request'))
                      <div>
                          <a
                          href="href="{{ route('password.request') }}""
                          class="hover:text-primaryColor relative after:absolute after:left-0 after:bottom-0.5 after:w-0 after:h-0.5 after:bg-primaryColor after:transition-all after:duration-300 hover:after:w-full"
              ...
              >
                ...
                <form method="POST" action="{{ route('register') }}" class="pt-25px" data-aos="fade-up">
                @csrf
                  <div
