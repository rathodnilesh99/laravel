                ...
                <div class="relative">
                    <div>
                        <img class="absolute bottom-9 lg:bottom-[-50px] right-[50px] animate-move-hor"
                            src="{{ asset('./assets/images/service/service__shape__1.png') }}" alt="">
                    </div>
                    <span
            ...
            <div class="relative z-0 overflow-visible">
                ...
                <div data-aos="fade-up">
                    <img class="absolute sm:block xl:left-1/4 z-[-1] top-6 animate-move-var"
                        src="{{ asset('./assets/images/service/service__shape__bg__1.png') }}" alt="">
                </div>
                <!-- subject card -->
                            ...
                            <div class="-translate-y-2 flex justify-between overflow-hidden mb-10px">
                                <div class="relative w-20 h-[60px]">
                                    <svg class="absolute inline-block translate-y-3 translate-x-2 w-20 h-[60px]"
                                        ...
                                        <path class="group-hover:fill-whiteColor dark:group-hover:fill-whiteColor-dark"
                                    ...
                                    <div class="service__bg__img w-20 h-[60px]">
                                        <svg class="w-20 h-[60px]" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                            ...
                            <div>
                                ...
                                <div>
                                    <div
                                        ...
                                        <a href="#"
                                            class="text-sm font-medium hover:text-secondaryColor transition-none">View
                                            Subject
                                ...
                                <div class="-translate-y-2 flex justify-between overflow-hidden mb-10px">
                                    <div class="relative w-20 h-[60px]">
                                        <svg class="absolute inline-block translate-y-3 translate-x-2 w-20 h-[60px]"
                                            ...
                                            <path
                                                class="group-hover:fill-whiteColor dark:group-hover:fill-whiteColor-dark"
                                                d="M34.5884 35.3186H14.4117V37.9969H34.5884V35.3186Z" fill="#5F2DED">
                                            </path>
                                            <path
                                                class="group-hover:fill-whiteColor dark:group-hover:fill-whiteColor-dark"
                                            ...
                                            <path
                                                class="group-hover:fill-whiteColor dark:group-hover:fill-whiteColor-dark"
                                                d="M25.9355 2.17908H23.0645V6.19654H25.9355V2.17908Z" fill="#5F2DED">
                                            </path>
                                            <path
                                                class="group-hover:fill-whiteColor dark:group-hover:fill-whiteColor-dark"
                                ...
                                <div>
                                    ...
                                    <div>
                                        <div
                                            class="text-sm text-black dark:text-blackColor-darkColor group-hover:text-whiteColor dark:text-blackColor-dark dark:group-hover:text-whiteColor-dark">
                                            <a href="#"
                                                class="text-sm font-medium hover:text-secondaryColor transition-all duration-300">View
                                                Subject
                                                <i class="icofont-long-arrow-right"></i></a>
                                        </div>
                                    </div>
